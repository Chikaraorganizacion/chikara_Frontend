  ...
  return (
    <div>
      ...
      <div className='flex items-center lg:pl-5 gap-5 relative z-10'>
        <button 
          class="flex items-center justify-center ml-auto mr-0 w-14 h-14 text-xl bg-red-600 text-white rounded-full lg:hidden"
          onClick= {() => setOpenMenu(!openMenu)}
          title='Botón que despliega el menu de la barra de navegación'
        >            
          {openMenu ? 
