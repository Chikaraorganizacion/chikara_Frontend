...
const FAQ = () => {
  ...
  return (
    <div className="mt-6 xl:mt-12 shadow-sm">
      {faqs.map((faq, index) => (
        <div key={index} className="border border-gray-200 mb-6 hover:border-gray-400 last:mb-0 transition hover:bg-gradient-to-t from-red-100 to-gray-100 shadow-md rounded-md hover:scale-105 transition-all duration-300">
          <button
          ...
          >
            ...
            <span className='self-start flex-none w-5 h-5'> 
              <svg className={`sm:inline-flex w-5 h-5 transition-all duration-300 ${openIndex === index ? 'rotate-45' : ''}`} aria-hidden="true">
