const InfoCard = (props) => {
  ...
  return (
    <article className='border-2 border-red-500 p-4 rounded-2xl grid grid-cols-2 xl:grid-cols-1 relative shadow-lg'>
      ...
      <div className='grid col-span-2 sm:col-span-1 z-10 relative'>
        <h3 className='text-lg font-bold text-center sm:mt-6 sm:text-xl dark:text-gray-200'>{title}</h3>
        <p className='p-4 text-base text-justify sm:text-xl dark:text-gray-200'>{info}</p>
      </div>
    </article>
  )
}
