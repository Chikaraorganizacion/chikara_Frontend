          ...
          <div className="z-10 relative">
            <div className="flex flex-col items-center gap-2 sm:flex-row sm:gap-3">
              <div className="w-full">
                <input type="email" id="hero-input" name="hero-input" className="py-3 px-4 block w-full border-4 border-gray-200 shadow-sm rounded-md focus:z-10 focus:border-red-500 focus:ring-red-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" placeholder="Ingresa tu correo electrónico aquí" required />
              </div>
