...
const Inscription = () => {
  ...
  return (
    <div id="inscription">
      <div>
        <h1>Formularío de Inscripción</h1>
      </div>
      <div>
        <Link to="/">
          Chikara - Inicio
      ...
      <div className={'lg:left-20 lg:top-80 flex items-center justify-center lg:w-full lg:h-full bg-gray-100 shadow-md shadow-gray-900 rounded border-2 border-red-500 py-6 px-4'}>
        <div>
          <div>
